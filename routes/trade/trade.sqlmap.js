...
function fnGetSellListCnt(param, conn) {
    return new Promise(function (resolve, reject) {
        ...
        sql += " and DATE_FORMAT(fn_get_time(ccsl.create_dt), '%Y-%m-%d') between DATE_FORMAT('"+param.srtDt+"', '%Y-%m-%d') and DATE_FORMAT('"+param.endDt+"', '%Y-%m-%d')"
        sql += " order by ccsl.create_dt desc";
